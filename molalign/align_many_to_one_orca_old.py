#!/usr/bin/env python3
"""
align_many_to_one_orca.py  (OPI version; no files kept)
...
def main(fileA, fileB, idxA, angles=[0], charge=0, mult=1,
         ncores=8, method="r2scan-3c"):
    """
    Align molB to grid idxA of molA, run ORCA SP via OPI, return dict of results.
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Align molB to one molA grid site and run ORCA SPs via OPI."
    )
